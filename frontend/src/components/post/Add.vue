        ...
        <q-dialog v-model="persistent" persistent transition-show="scale" transition-hide="scale" :maximized="isMobileNav">
            <q-card class="surface" :style="cardStyle">
                <q-card-section class="row items-center justify-between q-pb-none">
                    ...
                    <q-btn flat round dense icon="eva-close-outline" class="btn-inherit" @click="persistent = false" />
                </q-card-section>
                ...
                <q-card-actions align="right" class="q-pa-md">
                    <q-btn flat label="Cancel" class="btn-inherit" @click="persistent = false" />
